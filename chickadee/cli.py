...
template_env = Environment(
    loader=PackageLoader("chickadee", "templates"), autoescape=True
)
...
def get_host():
    ...
    url = url or "http://localhost:5004/wps"
...
@click.option(
    "--port", metavar="PORT", default="5004", help="port in PyWPS configuration."
)
@click.option(
    "--maxsingleinputsize",
    default="200mb",
...
def start(
    ...
    """Start PyWPS service.
    This service is by default available at http://localhost:5004/wps
    """
