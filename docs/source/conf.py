...
# -*- coding: utf-8 -*-
#
# chickadee documentation build configuration file, created by
...
# Add chickadee to sys.path to avoid having to full
# install chickadee for autodoc.
# Full install of chickadee will burst memory limit on ReadTheDocs.
...
htmlhelp_basename = "chickadeedoc"
